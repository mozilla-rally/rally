...
if ! echo "$NEW_VERSION" | grep --quiet --extended-regexp '(0|[1-9]\d*)\.(0|[1-9]\d*)\.(0|[1-9]\d*)(?:-((?:0|[1-9]\d*|\d*[a-zA-Z-][0-9a-zA-Z-]*)(?:\.(?:0|[1-9]\d*|\d*[a-zA-Z-][0-9a-zA-Z-]*))*))?(?:\+([0-9a-zA-Z-]+(?:\.[0-9a-zA-Z-]+)*))?$'; then
...
[Full changelog](https://github.com/mozilla-rally/rally-sdk/compare/v${NEW_VERSION}...master)
...
echo
echo "Once pushed, wait for the CI build to finish: https://circleci.com/gh/mozilla-rally/rally-sdk/tree/$branch"
